...
namespace SF::Engine
{
    void ImGuiDefaultStyle::SetStyle()
    {
        ...
        colors[ImGuiCol_BorderShadow] = ImVec4(0.1f, 0.1f, 0.0f, 1.00);
        style.Colors[ImGuiCol_Text] = ImVec4(1.00f, 1.00f, 1.00f, 1.00f);
        style.Colors[ImGuiCol_TextDisabled] = ImVec4(0.50f, 0.50f, 0.50f, 1.00f);
        style.Colors[ImGuiCol_Border] = (ImVec4)ImColor(IM_COL32(61, 61, 61, 255));;
        style.Colors[ImGuiCol_BorderShadow] = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
        style.Colors[ImGuiCol_FrameBg] = ImVec4(0.25f, 0.25f, 0.25f, 1.00f);
        style.Colors[ImGuiCol_WindowBg] = (ImVec4)ImColor(IM_COL32(15, 15, 15, 255));
        style.Colors[ImGuiCol_FrameBg] = ImVec4(0.25f, 0.25f, 0.25f, 1.00f);
        style.Colors[ImGuiCol_FrameBgHovered] = ImVec4(0.38f, 0.38f, 0.38f, 1.00f);
        style.Colors[ImGuiCol_FrameBgActive] = ImVec4(0.67f, 0.67f, 0.67f, 1.00f);
        style.Colors[ImGuiCol_TitleBg] = (ImVec4)ImColor(IM_COL32(22, 22, 22, 255));
        style.Colors[ImGuiCol_TitleBgActive] = (ImVec4)ImColor(IM_COL32(22, 22, 22, 255));
        style.Colors[ImGuiCol_TitleBgCollapsed] = (ImVec4)ImColor(IM_COL32(22, 22, 22, 255));
