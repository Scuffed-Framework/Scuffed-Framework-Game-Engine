...
#include <ThirdParty/utf8cpp/utf8/checked.h>
...
namespace libebml
{
        ...
        : EbmlElementDefaultStorage<const wchar_t *, UTFstring>(classInfo, 0)
    {
        ...
        {
            const auto &def =
                static_cast<const EbmlCallbacksWithDefault<const wchar_t *> &>(classInfo);
    ...
    */
    filepos_t EbmlUnicodeString::RenderData(IOCallback &output, bool /* bForceRender */,
                                            const ShouldWrite & /* writeFilter */)
    {
        ...
        {
            // pad the rest with 0
            std::string Pad(static_cast<std::string::size_type>(GetDefaultSize() - Result),
                            static_cast<char>(0));
    ...
    */
    filepos_t EbmlUnicodeString::ReadData(IOCallback &input, ScopeMode ReadFully)
    {
        ...
        {
            std::string Buffer(static_cast<std::string::size_type>(GetSize()),
                               static_cast<char>(0));
