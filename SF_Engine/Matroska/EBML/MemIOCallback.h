...
namespace libebml
{
    ...
    public:
        ...
        */
        ...
        const binary* GetDataBuffer() const
        {
            return dataBuffer.data();
        }
        std::uint64_t GetDataBufferSize() const
        {
            return dataBufferTotalSize;
        }
        void SetDataBufferSize(std::uint64_t newDataBufferSize)
        {
            dataBufferTotalSize = newDataBufferSize;
        }
        /*!
