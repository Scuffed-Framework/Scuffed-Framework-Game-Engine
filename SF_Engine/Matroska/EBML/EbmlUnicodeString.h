...
namespace libebml
{
    ...
    */
    ...
    /*!
      ...
      \note internally treated as a string made of wide characters (ie UCS-2 or UCS-4 depending on
      the machine)
    */
    class EbmlUnicodeString : public EbmlElementDefaultStorage<const wchar_t*, UTFstring>
    {
    public:
