...
namespace libebml
{
    ...
    */
    class EbmlUInteger : public EbmlElementDefaultSameStorage<std::uint64_t>
    {
    public:
        ...
        */
        void SetDefaultSize(std::uint64_t nDefaultSize = DEFAULT_UINT_SIZE) override
        {
            EbmlElement::SetDefaultSize(nDefaultSize);
            SetSize_(nDefaultSize);
        }
