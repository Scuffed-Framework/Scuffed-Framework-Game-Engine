...
namespace libebml
{
    ...
    */
    unsigned int CodedSizeLength(std::uint64_t Value, unsigned int MinSizeLength,
    ...
    */
    int CodedValueLength(std::uint64_t Value, int CodedSize, binary* OutBuffer);

    /*!
      \brief Read an EBML-coded value from a buffer
      \return the value read
    */
    std::uint64_t ReadCodedSizeValue(const binary* InBuffer, std::uint32_t& BufferSize,
...
#define DEFINE_xxx_CONTEXT(x, global)                                                          \
    const libebml::EbmlSemanticContextMaster Context_##x = libebml::EbmlSemanticContextMaster( \
        countof(ContextList_##x), ContextList_##x, nullptr, global, nullptr);

#define DEFINE_xxx_MASTER(x, id, parent, infinite, name, versions, global)         \
    DEFINE_xxx_MASTER_CONS(x, id, parent, infinite, name, versions, global) x::x() \
        : libebml::EbmlMaster(x::ClassInfos)                                       \
    {                                                                              \
    }

// define a master class with a custom constructor
#define DEFINE_xxx_MASTER_CONS(x, id, parent, infinite, name, versions, global)                   \
    static constexpr const libebml::EbmlId Id_##x{id};                                            \
    static_assert(libebml::EbmlId::IsValid(Id_##x.GetValue()), "invalid id for " name);           \
    constexpr const libebml::EbmlSemanticContextMaster x::SemanticContext =                       \
        libebml::EbmlSemanticContextMaster(countof(ContextList_##x), ContextList_##x,             \
                                           &parent::SemanticContext, global, &EBML_INFO(x));      \
    constexpr const libebml::EbmlCallbacksMaster x::ClassInfos(x::Create, Id_##x, infinite, name, \
                                                               x::SemanticContext, versions);
...
#define DEFINE_xxx_MASTER_ORPHAN(x, id, infinite, name, versions, global)                         \
    ...
    static_assert(libebml::EbmlId::IsValid(Id_##x.GetValue()), "invalid id for " name);           \
    constexpr const libebml::EbmlSemanticContextMaster x::SemanticContext =                       \
        libebml::EbmlSemanticContextMaster(countof(ContextList_##x), ContextList_##x, nullptr,    \
                                           global, &EBML_INFO(x));                                \
    constexpr const libebml::EbmlCallbacksMaster x::ClassInfos(x::Create, Id_##x, infinite, name, \
                                                               x::SemanticContext, versions);
...
#define DEFINE_xxx_CLASS_CONS(x, id, parent, name, global)                              \
    static constexpr const libebml::EbmlId Id_##x{id};                                  \
    static_assert(libebml::EbmlId::IsValid(Id_##x.GetValue()), "invalid id for " name); \
    static constexpr const libebml::EbmlSemanticContext Context_##x =                   \
        libebml::EbmlSemanticContext(&parent::SemanticContext, global, &EBML_INFO(x));

#define DEFINE_xxx_CLASS_BASE(x, BaseClass, id, parent, name, versions, global)                \
    DEFINE_xxx_CLASS_CONS(                                                                     \
        x, id, parent, name,                                                                   \
        global) constexpr const libebml::EbmlCallbacks x::ClassInfos(x::Create, Id_##x, false, \
                                                                     false, name, Context_##x, \
                                                                     versions);                \
    x::x() : BaseClass(x::ClassInfos) {}

#define DEFINE_xxx_CLASS_BASE_DEFAULT(x, BaseClass, id, parent, name, global, StorageType, defval, \
                                      versions)                                                    \
    DEFINE_xxx_CLASS_CONS(x, id, parent, name,                                                     \
                          global) constexpr const libebml::EbmlCallbacksWithDefault<StorageType>   \
        x::ClassInfos(x::Create, Id_##x, defval, name, Context_##x, versions);                     \
    x::x() : BaseClass(x::ClassInfos) {}

#define DEFINE_xxx_CLASS_BASE_NODEFAULT(x, BaseClass, id, parent, name, global, StorageType, \
                                        versions)                                            \
    DEFINE_xxx_CLASS_CONS(x, id, parent, name,                                               \
                          global) constexpr const libebml::EbmlCallbacksDefault<StorageType> \
        x::ClassInfos(x::Create, Id_##x, name, Context_##x, versions);                       \
    x::x() : BaseClass(x::ClassInfos) {}

#define DEFINE_xxx_UINTEGER(x, id, parent, name, versions, global)                            \
    DEFINE_xxx_CLASS_BASE_NODEFAULT(x, EbmlUInteger, id, parent, name, global, std::uint64_t, \
                                    versions)

#define DEFINE_xxx_SINTEGER(x, id, parent, name, versions, global)                           \
    DEFINE_xxx_CLASS_BASE_NODEFAULT(x, EbmlSInteger, id, parent, name, global, std::int64_t, \
                                    versions)
...
#define DEFINE_xxx_UNISTRING(x, id, parent, name, versions, global)                 \
    DEFINE_xxx_CLASS_BASE_NODEFAULT(x, EbmlUnicodeString, id, parent, name, global, \
...
#define DEFINE_xxx_UINTEGER_DEF(x, id, parent, name, versions, global, defval)              \
    DEFINE_xxx_CLASS_BASE_DEFAULT(x, EbmlUInteger, id, parent, name, global, std::uint64_t, \
                                  defval, versions)

#define DEFINE_xxx_SINTEGER_DEF(x, id, parent, name, versions, global, defval)                     \
    DEFINE_xxx_CLASS_BASE_DEFAULT(x, EbmlSInteger, id, parent, name, global, std::int64_t, defval, \
                                  versions)

#define DEFINE_xxx_STRING_DEF(x, id, parent, name, versions, global, defval)                    \
    DEFINE_xxx_CLASS_BASE_DEFAULT(x, EbmlString, id, parent, name, global, const char*, defval, \
                                  versions)

#define DEFINE_xxx_UNISTRING_DEF(x, id, parent, name, versions, global, defval)                   \
    DEFINE_xxx_CLASS_BASE_DEFAULT(x, EbmlUnicodeString, id, parent, name, global, const wchar_t*, \
                                  defval, versions)
...
#define DEFINE_xxx_CLASS_ORPHAN(x, id, name, versions, global)                                  \
    ...
    static_assert(libebml::EbmlId::IsValid(Id_##x.GetValue()), "invalid id for " name);         \
    static constexpr const libebml::EbmlSemanticContext Context_##x =                           \
        libebml::EbmlSemanticContext(nullptr, global, nullptr);                                 \
    constexpr const libebml::EbmlCallbacks x::ClassInfos(x::Create, Id_##x, false, false, name, \
                                                         Context_##x, versions);

#define DEFINE_EBML_CONTEXT(x) DEFINE_xxx_CONTEXT(x, GetEbmlGlobal_Context)

#define DEFINE_EBML_MASTER(x, id, parent, infinite, name, versions) \
    DEFINE_xxx_MASTER(x, id, parent, infinite, name, versions, GetEbmlGlobal_Context)
#define DEFINE_EBML_MASTER_ORPHAN(x, id, infinite, name, versions) \
    DEFINE_xxx_MASTER_ORPHAN(x, id, infinite, name, versions, GetEbmlGlobal_Context)
#define DEFINE_EBML_CLASS_ORPHAN(x, id, name, versions) \
    DEFINE_xxx_CLASS_ORPHAN(x, id, name, versions, GetEbmlGlobal_Context)
#define DEFINE_EBML_UINTEGER_DEF(x, id, parent, name, val, versions) \
    DEFINE_xxx_UINTEGER_DEF(x, id, parent, name, versions, GetEbmlGlobal_Context, val)
#define DEFINE_EBML_STRING_DEF(x, id, parent, name, val, versions) \
    DEFINE_xxx_STRING_DEF(x, id, parent, name, versions, GetEbmlGlobal_Context, val)
...
#define DEFINE_SEMANTIC_ITEM_UINT(m, u, d, c) \
    EbmlSemantic(m, u, static_cast<std::uint64_t>(d), EBML_INFO(c)),
#define DEFINE_SEMANTIC_ITEM_SINT(m, u, d, c) \
    EbmlSemantic(m, u, static_cast<std::int64_t>(d), EBML_INFO(c)),
#define DEFINE_SEMANTIC_ITEM_DATE(m, u, d, c) \
    EbmlSemantic(m, u, static_cast<std::int64_t>(d, true), EBML_INFO(c)),
#define DEFINE_SEMANTIC_ITEM_FLOAT(m, u, d, c) \
    EbmlSemantic(m, u, static_cast<double>(d), EBML_INFO(c)),
#define DEFINE_SEMANTIC_ITEM_STRING(m, u, d, c) \
    EbmlSemantic(m, u, static_cast<const char*>(d), EBML_INFO(c)),
#define DEFINE_SEMANTIC_ITEM_UTF8(m, u, d, c) \
    EbmlSemantic(m, u, static_cast<const wchar_t*>(d), EBML_INFO(c)),

#define DECLARE_xxx_BASE_DEFAULT(x, BaseClass, StorageType)                                     \
    ...
    private:                                                                                    \
        static const libebml::EbmlCallbacksWithDefault<StorageType> ClassInfos;                 \
                                                                                                \
    public:                                                                                     \
        const libebml::EbmlCallbacksWithDefault<StorageType>& ElementSpec() const override      \
        {                                                                                       \
            return ClassInfos;                                                                  \
        }                                                                                       \
        static constexpr const libebml::EbmlCallbacksWithDefault<StorageType>& GetElementSpec() \
        {                                                                                       \
            return ClassInfos;                                                                  \
        }                                                                                       \
        x();

#define DECLARE_xxx_BASE_NODEFAULT(x, BaseClass, StorageType)                               \
    class x : public BaseClass                                                              \
    {                                                                                       \
    private:                                                                                \
        static const libebml::EbmlCallbacksDefault<StorageType> ClassInfos;                 \
                                                                                            \
    public:                                                                                 \
        const libebml::EbmlCallbacksDefault<StorageType>& ElementSpec() const override      \
        {                                                                                   \
            return ClassInfos;                                                              \
        }                                                                                   \
        static constexpr const libebml::EbmlCallbacksDefault<StorageType>& GetElementSpec() \
        {                                                                                   \
            return ClassInfos;                                                              \
        }                                                                                   \
        x();

#define DECLARE_xxx_BASE_MASTER(x, BaseClass)                                 \
    class x : public BaseClass                                                \
    {                                                                         \
    private:                                                                  \
        static const libebml::EbmlCallbacksMaster ClassInfos;                 \
                                                                              \
    public:                                                                   \
        const libebml::EbmlCallbacksMaster& ElementSpec() const override      \
        {                                                                     \
            return ClassInfos;                                                \
        }                                                                     \
        static constexpr const libebml::EbmlCallbacksMaster& GetElementSpec() \
        {                                                                     \
            return ClassInfos;                                                \
        }                                                                     \
        x();

#define DECLARE_xxx_BASE(x, BaseClass)                                  \
    class x : public BaseClass                                          \
    {                                                                   \
    private:                                                            \
        static const libebml::EbmlCallbacks ClassInfos;                 \
                                                                        \
    public:                                                             \
        static constexpr const libebml::EbmlCallbacks& GetElementSpec() \
        {                                                               \
            return ClassInfos;                                          \
        }                                                               \
        x();

#define DECLARE_xxx_MASTER(x)                                                                    \
    DECLARE_xxx_BASE_MASTER(                                                                     \
        x, libebml::EbmlMaster) static const libebml::EbmlSemanticContextMaster SemanticContext; \
    static const libebml::EbmlSemanticContextMaster& GetContextMaster()                          \
    {                                                                                            \
        return SemanticContext;                                                                  \
    }

#define DECLARE_xxx_BINARY(x) DECLARE_xxx_BASE(x, libebml::EbmlBinary)

#define DECLARE_xxx_BINARY_LENGTH(x, len)                                                        \
    DECLARE_xxx_BASE(x, libebml::EbmlBinary) bool SizeIsValid(std::uint64_t size) const override \
    {                                                                                            \
        return size == len;                                                                      \
    }

#define DECLARE_xxx_UINTEGER(x) DECLARE_xxx_BASE_NODEFAULT(x, libebml::EbmlUInteger, std::uint64_t)

#define DECLARE_xxx_SINTEGER(x) DECLARE_xxx_BASE_NODEFAULT(x, libebml::EbmlSInteger, std::int64_t)

#define DECLARE_xxx_STRING(x) DECLARE_xxx_BASE_NODEFAULT(x, libebml::EbmlString, const char*)

#define DECLARE_xxx_UNISTRING(x) \
    DECLARE_xxx_BASE_NODEFAULT(x, libebml::EbmlUnicodeString, const wchar_t*)

#define DECLARE_xxx_DATE(x) DECLARE_xxx_BASE_NODEFAULT(x, libebml::EbmlDate, std::int64_t)

#define DECLARE_xxx_FLOAT(x) DECLARE_xxx_BASE_NODEFAULT(x, libebml::EbmlFloat, double)

#define DECLARE_xxx_UINTEGER_DEF(x) \
    DECLARE_xxx_BASE_DEFAULT(x, libebml::EbmlUInteger, std::uint64_t)

#define DECLARE_xxx_SINTEGER_DEF(x) DECLARE_xxx_BASE_DEFAULT(x, libebml::EbmlSInteger, std::int64_t)

#define DECLARE_xxx_STRING_DEF(x) DECLARE_xxx_BASE_DEFAULT(x, libebml::EbmlString, const char*)

#define DECLARE_xxx_UNISTRING_DEF(x) \
    DECLARE_xxx_BASE_DEFAULT(x, libebml::EbmlUnicodeString, const wchar_t*)

#define DECLARE_xxx_DATE_DEF(x) DECLARE_xxx_BASE_DEFAULT(x, libebml::EbmlDate, std::int64_t)

#define DECLARE_xxx_FLOAT_DEF(x) DECLARE_xxx_BASE_DEFAULT(x, libebml::EbmlFloat, double)

#define DECLARE_EBML_MASTER(x) DECLARE_xxx_MASTER(x)
#define DECLARE_EBML_UINTEGER_DEF(x) DECLARE_xxx_UINTEGER_DEF(x)
#define DECLARE_EBML_STRING_DEF(x) DECLARE_xxx_STRING_DEF(x)
#define DECLARE_EBML_BINARY(x) DECLARE_xxx_BINARY(x)
#define DECLARE_EBML_BINARY_LENGTH(x, len) DECLARE_xxx_BINARY_LENGTH(x, len)

#define EBML_CONCRETE_CLASS(Type)                              \
public:                                                        \
    libebml::EbmlElement* Clone() const override               \
    {                                                          \
        return new Type(*this);                                \
    }                                                          \
    static libebml::EbmlElement& Create()                      \
    {                                                          \
        return *(new Type);                                    \
    }                                                          \
    static constexpr const libebml::EbmlCallbacks& ClassInfo() \
    {                                                          \
        return ClassInfos;                                     \
    }
...
#define INVALID_FILEPOS_T 0
    ...
    public:
        ...
        //
        // \param min the minimum supported version, or ANY_VERSION to make the element never
        // available
        // \param max the maximum supported version, 0 to make the element never available or
        // ANY_VERSION to be supported on any known and unknown doctype version
        constexpr EbmlDocVersion(const std::string_view& name_space, version_type min = 0,
                                 version_type max = ANY_VERSION)
            : minver(min), maxver(max), ns(name_space)
        {
        }
        ...
        // return true if the element with this EbmlDocVersion can be used with the given
        // doctype_version
        bool IsValidInVersion(version_type doctype_version) const
        {
            if (minver == ANY_VERSION) return false;
            if (doctype_version < minver) return false;
        ...
        version_type GetMinVersion() const
        {
            return minver;
        }
        ...
        version_type GetMaxVersion() const
        {
            return maxver;
        }

        constexpr const std::string_view& GetNameSpace() const
        {
            return ns;
        }

        /// @brief constant value to indicate the maximum version matches all versions or the
        /// minimum version matches no version
    ...
    public:
        ...
        constexpr EbmlCallbacks(const CreateOperator& Creator, const EbmlId& aGlobalId,
                                bool aCanInfinite, bool aHasDefault, const char* aDebugName,
                                const EbmlSemanticContext& aContext, const EbmlDocVersion& aVersion)
            : Create(Creator),
              GlobalId(aGlobalId),
        ...
        inline constexpr const EbmlId& ClassId() const
        {
            return GlobalId;
        }
        inline constexpr const EbmlSemanticContext& GetContext() const
        {
            return Context;
        }
        ...
        inline EbmlElement& NewElement() const
        {
            return Create();
        }
        /// is infinite/unknown size allowed
        inline constexpr bool CanHaveInfiniteSize() const
        {
            return CanInfinite;
        }
        inline constexpr bool HasDefault() const
        {
            return hasDefault;
        }
        // get information about supported version for this element
        inline constexpr const EbmlDocVersion& GetVersions() const
        {
            return Version;
        }
    ...
    template <typename T>
    class EbmlCallbacksDefault : public EbmlCallbacks
    {
    public:
        constexpr EbmlCallbacksDefault(EbmlElement& (*Creator)(), const EbmlId& aGlobalId,
    ...
    template <typename T>
    class EbmlCallbacksWithDefault : public EbmlCallbacksDefault<T>
    {
    public:
        constexpr EbmlCallbacksWithDefault(EbmlElement& (*Creator)(), const EbmlId& aGlobalId,
                                           const T& def, const char* aDebugName,
                                           const EbmlSemanticContext& aContext,
    ...
    */
    ...
    public:
        ...
        inline constexpr bool IsMandatory() const
        {
            return Mandatory;
        }
        inline constexpr bool IsUnique() const
        {
            return Unique;
        }
        inline constexpr EbmlCallbacks const& GetCallbacks() const
        {
            return Callbacks;
        }
    ...
    */
    ...
    {
    protected:
        constexpr EbmlSemanticContext(std::size_t aSize, const EbmlSemanticContext* aUpTable,
                                      const _GetSemanticContext aGetGlobalContext,
                                      const EbmlCallbacks* aMasterElt)
            : GetGlobalContext(aGetGlobalContext),
              Size(aSize),
              UpTable(aUpTable),
    ...
    public:
        constexpr EbmlSemanticContext(const EbmlSemanticContext* aUpTable,
                                      const _GetSemanticContext aGetGlobalContext,
                                      const EbmlCallbacks* aMasterElt)
            : GetGlobalContext(aGetGlobalContext), Size(0), UpTable(aUpTable), MasterElt(aMasterElt)
        {
        }

        bool operator!=(const EbmlSemanticContext& aElt) const
        {
            return ((Size != aElt.Size) || (UpTable != aElt.UpTable) ||
                    (GetGlobalContext != aElt.GetGlobalContext) || (MasterElt != aElt.MasterElt));
        }
        ...
        inline constexpr const EbmlCallbacks* GetMaster() const
        {
            return MasterElt;
        }
        inline constexpr const EbmlSemanticContext* Parent() const
        {
            return UpTable;
        }
    ...
    static inline constexpr const EbmlSemanticContext* tEBML_CTX_PARENT(
        const EbmlSemanticContext& c)
    {
        return c.Parent();
    }

    class EbmlSemanticContextMaster : public EbmlSemanticContext
    {
    public:
        constexpr EbmlSemanticContextMaster(std::size_t aSize, const EbmlSemantic* aMyTable,
                                            const EbmlSemanticContext* aUpTable,
                                            const _GetSemanticContext aGetGlobalContext,
                                            const EbmlCallbacks* aMasterElt)
            : EbmlSemanticContext(aSize, aUpTable, aGetGlobalContext, aMasterElt), MyTable(aMyTable)
        {
        }

        bool operator!=(const EbmlSemanticContext& aElt) const
        {
            if (EbmlSemanticContext::operator!=(aElt)) return true;
    ...
    static inline const EbmlSemantic& tEBML_CTX_IDX(const EbmlSemanticContextMaster& c,
                                                    std::size_t i)
    {
        return c.GetSemantic(i);
    }

    class EbmlCallbacksMaster : public EbmlCallbacks
    {
    public:
        constexpr EbmlCallbacksMaster(EbmlElement& (*Creator)(), const EbmlId& aGlobalId,
                                      bool aCanInfinite, const char* aDebugName,
                                      const EbmlSemanticContextMaster& aContext,
                                      const EbmlDocVersion& aVersion)
    ...
    */
    ...
    public:
        ...
        {
            if (elt.IsDefaultValue()) return false;
        ...
        explicit EbmlElement(const EbmlCallbacks&, std::uint64_t aDefaultSize,
                             bool bValueSet = false);
        virtual ~EbmlElement() = default;
        EbmlElement& operator=(const EbmlElement&) = delete;

        virtual const EbmlCallbacks& ElementSpec() const
        {
            return ClassInfo;
        }

        /// Set the minimum length that will be used to write the element size (-1 = optimal)
        void SetSizeLength(unsigned int NewSizeLength)
        {
            SizeLength = NewSizeLength;
        }
        unsigned int GetSizeLength() const
        {
            return SizeLength;
        }

        static EbmlElement* FindNextElement(IOCallback& DataStream,
                                            const EbmlSemanticContext& Context, int& UpperLevel,
                                            std::uint64_t MaxDataSize, bool AllowDummyElt,
                                            unsigned int MaxLowerLevel = 1);
        static EbmlElement* FindNextID(IOCallback& DataStream, const EbmlCallbacks& ClassInfos,
                                       std::uint64_t MaxDataSize);

        /*!
          \brief find the next element with the same ID
        */
        EbmlElement* SkipData(EbmlStream& DataStream, const EbmlSemanticContext& Context,
                              EbmlElement* TestReadElt = nullptr, bool AllowDummyElt = false);
        ...
        */
        ...
        virtual EbmlId const& GetClassId() const
        {
            return EBML_INFO_ID(ClassInfo);
        }
        virtual explicit operator const EbmlId&() const
        {
            return GetClassId();
        }
        constexpr const char* DebugName() const
        {
            return ClassInfo.GetName();
        }
        constexpr const EbmlSemanticContext& Context() const
        {
            return ClassInfo.GetContext();
        }
        EbmlElement& CreateElement() const
        {
            return EBML_INFO_CREATE(ClassInfo);
        }
        ...
        std::uint64_t ElementSize(const ShouldWrite& writeFilter = WriteSkipDefault)
            const;  /// return the size of the header+data, before writing

        filepos_t Render(IOCallback& output, const ShouldWrite& writeFilter = WriteSkipDefault,
                         bool bKeepPosition = false, bool bForceRender = false);

        virtual filepos_t UpdateSize(
            const ShouldWrite& writeFilter = WriteSkipDefault,
            bool bForceRender = false) = 0;  /// update the Size of the Data stored
        ...
        virtual void Read(EbmlStream& inDataStream, const EbmlSemanticContext& Context,
                          int& UpperEltFound, EbmlElement*& FoundElt, bool AllowDummyElt = false,
        ...
        */
        std::uint64_t VoidMe(IOCallback& output,
                             const ShouldWrite& writeFilter = WriteSkipDefault) const;

        virtual bool IsDefaultValue() const = 0;
        bool IsFiniteSize() const
        {
            return bSizeIsFinite;
        }

        /*!
          \brief set the default size of an element
        */
        virtual void SetDefaultSize(std::uint64_t aDefaultSize)
        {
    ...
    protected:
        /*!
          ...
          \return a DummyRawElement if the element is unknown or nullptr if the element dummy is not
          allowed
        */
        static EbmlElement* CreateElementUsingContext(const EbmlId& aID,
                                                      const EbmlSemanticContext& Context,
                                                      int& LowLevel, bool IsGlobalContext,
                                                      bool AsInfiniteSize, bool bAllowDummy = false,
                                                      unsigned int MaxLowerLevel = 1);

        filepos_t RenderHead(IOCallback& output, bool bForceRender,
                             const ShouldWrite& writeFilter = WriteSkipDefault,
        ...
        */
        virtual filepos_t RenderData(IOCallback& output, bool bForceRender,
                                     const ShouldWrite& writeFilter = WriteSkipDefault) = 0;
        ...
        */
        ...
        inline std::uint64_t GetDefaultSize() const
        {
            return DefaultSize;
        }
        inline void SetSize_(std::uint64_t aSize)
        {
            Size = aSize;
        }
        inline void SetValueIsSet(bool Set = true)
        {
            bValueIsSet = Set;
        }
        inline std::uint64_t GetSizePosition() const
        {
            return SizePosition;
        }
    ...
    private:
        ...
        {
            return EBML_ID_LENGTH(static_cast<const EbmlId&>(*this)) +
                   CodedSizeLength(Size, SizeLength, bSizeIsFinite);
        ...
        unsigned int SizeLength{
            0};  /// the minimum size on which the size will be written (0 = optimal)
        bool bSizeIsFinite{true};
     ...
     */
    template <typename T>
    class EbmlElementDefault : public EbmlElement
    {
    public:
        explicit EbmlElementDefault(const libebml::EbmlCallbacksDefault<T>& classInfo,
                                    std::uint64_t aDefaultSize)
        ...
        {
            if (!ElementSpec().HasDefault()) return false;
            if (!ValueIsSet()) return true;
    ...
    template <typename T>
    class EbmlElementDefaultSameStorage : public EbmlElementDefault<T>
    {
    public:
        ...
        {
            if (EbmlId(*this) != EbmlId(*Cmp)) return false;
    ...
    class EbmlElementDefaultStorage : public EbmlElementDefault<T>
    {
    public:
        using EbmlElementDefault<T>::EbmlElementDefault;
        using EbmlElementDefault<T>::operator const EbmlId&;
