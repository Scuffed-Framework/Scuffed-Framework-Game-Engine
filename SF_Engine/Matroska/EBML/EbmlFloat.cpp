...
namespace libebml
{
    ...
    EbmlFloat::EbmlFloat(const EbmlCallbacksDefault<double>& classInfo,
    ...
    EbmlFloat::operator float() const
    {
    ...
    */
    filepos_t EbmlFloat::RenderData(IOCallback& output, bool /* bForceRender */,
