...
namespace libebml
{
    ...
    DEFINE_EBML_UINTEGER_DEF(EMaxSizeLength, 0x42F3, EbmlHead, "EBMLMaxSizeLength", 8,
                             AllEbmlVersions)
    DEFINE_EBML_STRING_DEF(EDocType, 0x4282, EbmlHead, "EBMLDocType", "matroska", AllEbmlVersions)
    DEFINE_EBML_UINTEGER_DEF(EDocTypeVersion, 0x4287, EbmlHead, "EBMLDocTypeVersion", 1,
                             AllEbmlVersions)
    DEFINE_EBML_UINTEGER_DEF(EDocTypeReadVersion, 0x4285, EbmlHead, "EBMLDocTypeReadVersion", 1,
                             AllEbmlVersions)
    ...
    EbmlHead::EbmlHead() : EbmlMaster(EbmlHead::ClassInfos) {}
