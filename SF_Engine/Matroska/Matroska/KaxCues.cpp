...
namespace libmatroska
{
    ...
    KaxCues::~KaxCues()
    {
        assert(myTempReferences.empty());  // otherwise that means you have added references and
                                           // forgot to set the position
    }
    ...
    */
    bool KaxCues::AddBlockBlob(const KaxBlockBlob& BlockReference)
    {
        ...
        if (!present) myTempReferences.push_back(&BlockReference);
