...
namespace SF::Engine
{
    ...
    public:
         ...
         */
        Buffer(VkDeviceSize size, VkBufferUsageFlags usage, VmaMemoryUsage memoryUsage = VMA_MEMORY_USAGE_AUTO,
               VmaAllocationCreateFlags allocationFlags = 0, std::span<const std::byte> data = {});
