...
namespace SF::Engine
{
    ...
    public:
        ...
        RhiRenderpass(const LogicalDevice &logicalDevice, const RhiRenderStage &renderStage, VkFormat depthFormat,
                      VkFormat surfaceFormat, VkSampleCountFlagBits samples = VK_SAMPLE_COUNT_1_BIT);
        ~RhiRenderpass();
