...
namespace SF::Engine
{
    Image2dArray::Image2dArray(const UVec2 &extent, uint32_t arrayLayers, VkFormat format, VkImageLayout layout,
        ...
        anisotropic(anisotropic), mipmap(mipmap)
    {
        ...
        vkCmdCopyBufferToImage(commandBuffer, bufferStaging.GetBuffer(), image, VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL,
