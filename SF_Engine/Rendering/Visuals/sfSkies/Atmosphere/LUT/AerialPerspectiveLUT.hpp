...
namespace SF::Engine
{
    ...
    {
    public:
        explicit AerialPerspectiveLUT(Image2d *transmittanceLUT, Image2d *msLUT, uint32_t width = 32,
                                      uint32_t height = 32, uint32_t depth = 32) :
            width_(width), height_(height), depth_(depth)
        {
            ubo_ = std::make_unique<UniformBuffer>(sizeof(AtmosphereFrameUBO));

            aerialPerspColorRGBTransR_ = std::make_unique<Image3d>(
                    UVec3{width_, height_, depth_}, VK_FORMAT_R16G16B16A16_SFLOAT, VK_IMAGE_LAYOUT_GENERAL,
                    VK_IMAGE_USAGE_STORAGE_BIT | VK_IMAGE_USAGE_SAMPLED_BIT);

            aerialPerspTransGB_ = std::make_unique<Image3d>(UVec3{width_, height_, depth_}, VK_FORMAT_R16G16_SFLOAT,
                                                            VK_IMAGE_LAYOUT_GENERAL,
                                                            VK_IMAGE_USAGE_STORAGE_BIT | VK_IMAGE_USAGE_SAMPLED_BIT);

            aerialPerspRange_ =
                    std::make_unique<Image2d>(UVec2{width_, height_}, VK_FORMAT_R32_SFLOAT, VK_IMAGE_LAYOUT_GENERAL,
                                              VK_IMAGE_USAGE_STORAGE_BIT | VK_IMAGE_USAGE_SAMPLED_BIT);

            pipeline_ = std::make_unique<ComputePipeline>("Shaders/Atmosphere/AerialPerspectiveLUT.shader");
        ...
        void Bake(const CommandBuffer &cmd, const AtmosphereFrameUBO &frameData)
        {
            ...
            if (everBaked_)
            {
                Image::InsertImageMemoryBarrier(cmd, aerialPerspColorRGBTransR_->GetImage(), VK_ACCESS_SHADER_READ_BIT,
                ...
                Image::InsertImageMemoryBarrier(cmd, aerialPerspTransGB_->GetImage(), VK_ACCESS_SHADER_READ_BIT,
                                                VK_ACCESS_SHADER_WRITE_BIT, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL,
                                                VK_IMAGE_LAYOUT_GENERAL, VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT,
                                                VK_PIPELINE_STAGE_COMPUTE_SHADER_BIT, VK_IMAGE_ASPECT_COLOR_BIT, 1, 0,
                                                1, 0);

                Image::InsertImageMemoryBarrier(cmd, aerialPerspRange_->GetImage(), VK_ACCESS_SHADER_READ_BIT,
                                                VK_ACCESS_SHADER_WRITE_BIT, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL,
                                                VK_IMAGE_LAYOUT_GENERAL, VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT,
                                                VK_PIPELINE_STAGE_COMPUTE_SHADER_BIT, VK_IMAGE_ASPECT_COLOR_BIT, 1, 0,
                                                1, 0);
            ...
            Image::InsertImageMemoryBarrier(cmd, aerialPerspColorRGBTransR_->GetImage(), VK_ACCESS_SHADER_WRITE_BIT,
                                            VK_ACCESS_SHADER_READ_BIT, VK_IMAGE_LAYOUT_GENERAL,
                                            VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL,
                                            VK_PIPELINE_STAGE_COMPUTE_SHADER_BIT, VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT,
                                            VK_IMAGE_ASPECT_COLOR_BIT, 1, 0, 1, 0);

            Image::InsertImageMemoryBarrier(cmd, aerialPerspTransGB_->GetImage(), VK_ACCESS_SHADER_WRITE_BIT,
                                            VK_ACCESS_SHADER_READ_BIT, VK_IMAGE_LAYOUT_GENERAL,
                                            VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL,
                                            VK_PIPELINE_STAGE_COMPUTE_SHADER_BIT, VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT,
                                            VK_IMAGE_ASPECT_COLOR_BIT, 1, 0, 1, 0);

            Image::InsertImageMemoryBarrier(cmd, aerialPerspRange_->GetImage(), VK_ACCESS_SHADER_WRITE_BIT,
                                            VK_ACCESS_SHADER_READ_BIT, VK_IMAGE_LAYOUT_GENERAL,
                                            VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL,
                                            VK_PIPELINE_STAGE_COMPUTE_SHADER_BIT, VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT,
                                            VK_IMAGE_ASPECT_COLOR_BIT, 1, 0, 1, 0);
