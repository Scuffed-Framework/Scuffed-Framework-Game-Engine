...
namespace SF::Engine
{
    ...
    public:
        explicit CloudNoiseLUTs(uint32_t width = 32, uint32_t height = 32, uint32_t depth = 1)
        {
            ...
            CurlNoiseTexture_ =
                    std::make_unique<Image2d>(UVec2{width, height}, VK_FORMAT_R8G8B8A8_UNORM, VK_IMAGE_LAYOUT_GENERAL,
                                              VK_IMAGE_USAGE_STORAGE_BIT | VK_IMAGE_USAGE_SAMPLED_BIT);

            WeatherTexture_ = std::make_unique<Image2d>(UVec2{params_.resolution, params_.resolution},
            ...
            pipelineA_ = std::make_unique<ComputePipeline>("Shaders/Clouds/BaseNoise.shader");

            pipelineB_ = std::make_unique<ComputePipeline>("Shaders/Clouds/DetailNoise.shader");

            pipelineC_ = std::make_unique<ComputePipeline>("Shaders/Clouds/CurlNoise.shader");

            pipelineD_ = std::make_unique<ComputePipeline>("Shaders/Clouds/WeatherMap.shader");
            ...
            auto info0 = BaseNoiseTexture_->GetWriteDescriptor(0, VK_DESCRIPTOR_TYPE_STORAGE_IMAGE, std::nullopt);
            auto info1 = DetailNoiseTexture_->GetWriteDescriptor(0, VK_DESCRIPTOR_TYPE_STORAGE_IMAGE, std::nullopt);
            auto info2 = CurlNoiseTexture_->GetWriteDescriptor(0, VK_DESCRIPTOR_TYPE_STORAGE_IMAGE, std::nullopt);
            auto info3 = WeatherTexture_->GetWriteDescriptor(0, VK_DESCRIPTOR_TYPE_STORAGE_IMAGE, std::nullopt);
        ...
        void Bake(const CommandBuffer &cmd)
        {
            if (baked_)
            {
                Image::InsertImageMemoryBarrier(cmd, BaseNoiseTexture_->GetImage(), VK_ACCESS_SHADER_READ_BIT,
                                                ...
                                                VK_PIPELINE_STAGE_COMPUTE_SHADER_BIT, VK_IMAGE_ASPECT_COLOR_BIT, 1, 0,
                                                1, 0);
                Image::InsertImageMemoryBarrier(cmd, DetailNoiseTexture_->GetImage(), VK_ACCESS_SHADER_READ_BIT,
                                                VK_ACCESS_SHADER_WRITE_BIT, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL,
                                                VK_IMAGE_LAYOUT_GENERAL, VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT,
                                                VK_PIPELINE_STAGE_COMPUTE_SHADER_BIT, VK_IMAGE_ASPECT_COLOR_BIT, 1, 0,
                                                1, 0);
                Image::InsertImageMemoryBarrier(cmd, CurlNoiseTexture_->GetImage(), VK_ACCESS_SHADER_READ_BIT,
                                                VK_ACCESS_SHADER_WRITE_BIT, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL,
                                                VK_IMAGE_LAYOUT_GENERAL, VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT,
                                                VK_PIPELINE_STAGE_COMPUTE_SHADER_BIT, VK_IMAGE_ASPECT_COLOR_BIT, 1, 0,
                                                1, 0);

                Image::InsertImageMemoryBarrier(cmd, WeatherTexture_->GetImage(), VK_ACCESS_SHADER_READ_BIT,
                                                VK_ACCESS_SHADER_WRITE_BIT, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL,
                                                VK_IMAGE_LAYOUT_GENERAL, VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT,
                                                VK_PIPELINE_STAGE_COMPUTE_SHADER_BIT, VK_IMAGE_ASPECT_COLOR_BIT, 1, 0,
                                                1, 0);
            ...
            Image::InsertImageMemoryBarrier(cmd, BaseNoiseTexture_->GetImage(), VK_ACCESS_SHADER_WRITE_BIT,
                                            VK_ACCESS_SHADER_READ_BIT, VK_IMAGE_LAYOUT_GENERAL,
                                            VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL,
                                            VK_PIPELINE_STAGE_COMPUTE_SHADER_BIT, VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT,
                                            VK_IMAGE_ASPECT_COLOR_BIT, 1, 0, 1, 0);

            Image::InsertImageMemoryBarrier(cmd, DetailNoiseTexture_->GetImage(), VK_ACCESS_SHADER_WRITE_BIT,
                                            VK_ACCESS_SHADER_READ_BIT, VK_IMAGE_LAYOUT_GENERAL,
                                            VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL,
                                            VK_PIPELINE_STAGE_COMPUTE_SHADER_BIT, VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT,
                                            VK_IMAGE_ASPECT_COLOR_BIT, 1, 0, 1, 0);

            Image::InsertImageMemoryBarrier(cmd, CurlNoiseTexture_->GetImage(), VK_ACCESS_SHADER_WRITE_BIT,
                                            VK_ACCESS_SHADER_READ_BIT, VK_IMAGE_LAYOUT_GENERAL,
                                            VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL,
                                            VK_PIPELINE_STAGE_COMPUTE_SHADER_BIT, VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT,
                                            VK_IMAGE_ASPECT_COLOR_BIT, 1, 0, 1, 0);

            Image::InsertImageMemoryBarrier(cmd, WeatherTexture_->GetImage(), VK_ACCESS_SHADER_WRITE_BIT,
                                            VK_ACCESS_SHADER_READ_BIT, VK_IMAGE_LAYOUT_GENERAL,
                                            VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL,
                                            VK_PIPELINE_STAGE_COMPUTE_SHADER_BIT, VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT,
                                            VK_IMAGE_ASPECT_COLOR_BIT, 1, 0, 1, 0);
