...
namespace SF::Engine
{
    ...
    Mat4 Transform::GetWorldMatrix() const
    {
        ...
        Mat4 matrix(1.0f);
        matrix = translate(matrix, world.position);
        matrix = rotate(matrix, world.rotation.x, Vec3(1, 0, 0));
        matrix = rotate(matrix, world.rotation.y, Vec3(0, 1, 0));
        matrix = rotate(matrix, world.rotation.z, Vec3(0, 0, 1));
    ...
    bool Transform::operator!=(const Transform &rhs) const { return !operator==(rhs); }
    ...
    Transform &Transform::operator*=(const Transform &rhs) { return *this = *this * rhs; }
