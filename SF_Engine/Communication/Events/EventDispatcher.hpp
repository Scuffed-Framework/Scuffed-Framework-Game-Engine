...
namespace SF::Engine
{
    ...
    private:
        ...
        struct Listener : ListenerBase
        {
            ...
            Listener(size_t id, std::function<void(T &)> cb) : callback(std::move(cb)) { this->id = id; }

            void Invoke(Event &e) override { callback(static_cast<T &>(e)); }
        };
    ...
    public:
        ...
        {
            return Subscribe<EventType>([instance, method](EventType &e) { (instance->*method)(e); });
        }
    ...
    public:
        ...
        ScopedEventHandle(EventDispatcher *dispatcher, EventHandle handle) : _dispatcher(dispatcher), _handle(handle) {}
        ...
        ScopedEventHandle(ScopedEventHandle &&other) noexcept : _dispatcher(other._dispatcher), _handle(other._handle)
        {
