...
namespace ktxparse
{
    namespace detail
    {
        ...
        inline TargetInfo getTargetInfo(uint32_t width, uint32_t height, uint32_t depth,
                                        uint32_t layers, uint32_t faces)
        {
        ...
        struct FormatInfo
        {
            ...
            uint32_t getImageSize(uint32_t width, uint32_t height, uint32_t depth,
        ...
        inline FormatInfo getFormatInfo(uint32_t internalFormat, uint32_t format, uint32_t type)
        {
            ...
            switch (internalFormat)
            {
                case 0x2A10:  // GL_R3_G3_B2
                    i = {0x1907, 0x80E0, 0x8032, 0x8362, 1, 1, 1, 1, 1};
                    break;
                case 0x8051:  // GL_RGB8
                case 0x8C41:  // GL_SRGB8
                    i = {0x1907, 0x80E0, 0x1401, 0, 1, 1, 1, 1, 3};
                    break;
                case 0x8054:  // GL_RGB16
                    i = {0x1907, 0x80E0, 0x1403, 0, 2, 1, 1, 1, 6};
                    break;
                case 0x8056:  // GL_RGBA4
                    i = {0x1908, 0x80E1, 0x8033, 0x8365, 2, 1, 1, 1, 2};
                    break;
                case 0x8057:  // GL_RGB5_A1
                    i = {0x1908, 0x80E1, 0x8034, 0x8366, 2, 1, 1, 1, 2};
                    break;
                case 0x8058:  // GL_RGBA8
                case 0x8C43:  // GL_SRGB8_ALPHA8
                    i = {0x1908, 0x80E1, 0x1401, 0, 1, 1, 1, 1, 4};
                    break;
                case 0x8059:  // GL_RGB10_A2
                    i = {0x1908, 0x80E1, 0x8036, 0x8368, 4, 1, 1, 1, 4};
                    break;
                case 0x805B:  // GL_RGBA16
                    i = {0x1908, 0x80E1, 0x1403, 0, 2, 1, 1, 1, 8};
                    break;
                case 0x81A5:  // GL_DEPTH_COMPONENT16
                    i = {0x1902, 0, 0x1403, 0, 2, 1, 1, 1, 2};
                    break;
                case 0x81A6:  // GL_DEPTH_COMPONENT24
                    i = {0x1902, 0, 0x1405, 0, 4, 1, 1, 1, 4};
                    break;
                case 0x8229:  // GL_R8
                case 0x8FBD:  // GL_SR8_EXT
                    i = {0x1903, 0, 0x1401, 0, 1, 1, 1, 1, 1};
                    break;
                case 0x822A:  // GL_R16
                    i = {0x1903, 0, 0x1403, 0, 2, 1, 1, 1, 2};
                    break;
                case 0x822B:  // GL_RG8
                case 0x8FBE:  // GL_SRG8_EXT
                    i = {0x8227, 0, 0x1401, 0, 1, 1, 1, 1, 2};
                    break;
                case 0x822C:  // GL_RG16
                    i = {0x8227, 0, 0x1403, 0, 2, 1, 1, 1, 4};
                    break;
                case 0x822D:  // GL_R16F
                    i = {0x1903, 0, 0x140B, 0, 2, 1, 1, 1, 2};
                    break;
                case 0x822E:  // GL_R32F
                    i = {0x1903, 0, 0x1406, 0, 4, 1, 1, 1, 4};
                    break;
                case 0x822F:  // GL_RG16F
                    i = {0x8227, 0, 0x140B, 0, 2, 1, 1, 1, 4};
                    break;
                case 0x8230:  // GL_RG32F
                    i = {0x8227, 0, 0x1406, 0, 4, 1, 1, 1, 8};
                    break;
                case 0x8231:  // GL_R8I
                    i = {0x8D94, 0, 0x1400, 0, 1, 1, 1, 1, 1};
                    break;
                case 0x8232:  // GL_R8UI
                    i = {0x8D94, 0, 0x1401, 0, 1, 1, 1, 1, 1};
                    break;
                case 0x8233:  // GL_R16I
                    i = {0x8D94, 0, 0x1402, 0, 2, 1, 1, 1, 2};
                    break;
                case 0x8234:  // GL_R16UI
                    i = {0x8D94, 0, 0x1403, 0, 2, 1, 1, 1, 2};
                    break;
                case 0x8235:  // GL_R32I
                    i = {0x8D94, 0, 0x1404, 0, 4, 1, 1, 1, 4};
                    break;
                case 0x8236:  // GL_R32UI
                    i = {0x8D94, 0, 0x1405, 0, 4, 1, 1, 1, 4};
                    break;
                case 0x8237:  // GL_RG8I
                    i = {0x8228, 0, 0x1400, 0, 1, 1, 1, 1, 2};
                    break;
                case 0x8238:  // GL_RG8UI
                    i = {0x8228, 0, 0x1401, 0, 1, 1, 1, 1, 2};
                    break;
                case 0x8239:  // GL_RG16I
                    i = {0x8228, 0, 0x1402, 0, 2, 1, 1, 1, 4};
                    break;
                case 0x823A:  // GL_RG16UI
                    i = {0x8228, 0, 0x1403, 0, 2, 1, 1, 1, 4};
                    break;
                case 0x823B:  // GL_RG32I
                    i = {0x8228, 0, 0x1404, 0, 4, 1, 1, 1, 8};
                    break;
                case 0x823C:  // GL_RG32UI
                    i = {0x8228, 0, 0x1405, 0, 4, 1, 1, 1, 8};
                    break;
                ...
                case 0x93D0:  // GL_COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR
                    i = {0, 0, 0, 0, 1, 4, 4, 1, 16};
                    break;
                case 0x8814:  // GL_RGBA32F
                    i = {0x1908, 0x80E1, 0x1406, 0, 4, 1, 1, 1, 16};
                    break;
                case 0x8815:  // GL_RGB32F
                    i = {0x1907, 0x80E0, 0x1406, 0, 4, 1, 1, 1, 12};
                    break;
                case 0x881A:  // GL_RGBA16F
                    i = {0x1908, 0x80E1, 0x140B, 0, 2, 1, 1, 1, 8};
                    break;
                case 0x881B:  // GL_RGB16F
                    i = {0x1907, 0x80E0, 0x140B, 0, 2, 1, 1, 1, 6};
                    break;
                case 0x88F0:  // GL_DEPTH24_STENCIL8
                    i = {0x84F9, 0, 0x84FA, 0, 4, 1, 1, 1, 4};
                    break;
                ...
                case 0x8C02:  // GL_COMPRESSED_RGBA_PVRTC_4BPPV1_IMG
                    i = {0, 0, 0, 0, 1, 8, 8, 1, 32};
                    break;
                case 0x8C3A:  // GL_R11F_G11F_B10F
                    i = {0x1907, 0x80E0, 0, 0x8C3B, 4, 1, 1, 1, 4};
                    break;
                case 0x8C3D:  // GL_RGB9_E5
                    i = {0x1907, 0x80E0, 0, 0x8C3E, 4, 1, 1, 1, 4};
                    break;
                case 0x8CAC:  // GL_DEPTH_COMPONENT32F
                    i = {0x1902, 0, 0x1406, 0, 4, 1, 1, 1, 4};
                    break;
                case 0x8CAD:  // GL_DEPTH32F_STENCIL8
                    i = {0x84F9, 0, 0, 0x8DAD, 4, 1, 1, 1, 8};
                    break;
                case 0x8D48:  // GL_STENCIL_INDEX8
                    i = {0x1901, 0, 0x1401, 0, 1, 1, 1, 1, 1};
                    break;
                case 0x8D62:  // GL_RGB565
                    i = {0x1907, 0x80E0, 0x8363, 0x8364, 2, 1, 1, 1, 2};
                    break;
                case 0x8D70:  // GL_RGBA32UI
                    i = {0x8D99, 0x8D9B, 0x1405, 0, 4, 1, 1, 1, 16};
                    break;
                case 0x8D71:  // GL_RGB32UI
                    i = {0x8D98, 0x8D9A, 0x1405, 0, 4, 1, 1, 1, 12};
                    break;
                case 0x8D76:  // GL_RGBA16UI
                    i = {0x8D99, 0x8D9B, 0x1403, 0, 2, 1, 1, 1, 8};
                    break;
                case 0x8D77:  // GL_RGB16UI
                    i = {0x8D98, 0x8D9A, 0x1403, 0, 2, 1, 1, 1, 6};
                    break;
                case 0x8D7C:  // GL_RGBA8UI
                    i = {0x8D99, 0x8D9B, 0x1401, 0, 1, 1, 1, 1, 4};
                    break;
                case 0x8D7D:  // GL_RGB8UI
                    i = {0x8D98, 0x8D9A, 0x1401, 0, 1, 1, 1, 1, 3};
                    break;
                case 0x8D82:  // GL_RGBA32I
                    i = {0x8D99, 0x8D9B, 0x1404, 0, 4, 1, 1, 1, 16};
                    break;
                case 0x8D83:  // GL_RGB32I
                    i = {0x8D98, 0x8D9A, 0x1404, 0, 4, 1, 1, 1, 12};
                    break;
                case 0x8D88:  // GL_RGBA16I
                    i = {0x8D99, 0x8D9B, 0x1402, 0, 2, 1, 1, 1, 8};
                    break;
                case 0x8D89:  // GL_RGB16I
                    i = {0x8D98, 0x8D9A, 0x1402, 0, 2, 1, 1, 1, 6};
                    break;
                case 0x8D8E:  // GL_RGBA8I
                    i = {0x8D99, 0x8D9B, 0x1400, 0, 1, 1, 1, 1, 4};
                    break;
                case 0x8D8F:  // GL_RGB8I
                    i = {0x8D98, 0x8D9A, 0x1400, 0, 1, 1, 1, 1, 3};
                    break;
                case 0x8F94:  // GL_R8_SNORM
                    i = {0x1903, 0, 0x1400, 0, 1, 1, 1, 1, 1};
                    break;
                case 0x8F95:  // GL_RG8_SNORM
                    i = {0x8227, 0, 0x1400, 0, 1, 1, 1, 1, 2};
                    break;
                case 0x8F96:  // GL_RGB8_SNORM
                    i = {0x1907, 0x80E0, 0x1400, 0, 1, 1, 1, 1, 3};
                    break;
                case 0x8F97:  // GL_RGBA8_SNORM
                    i = {0x1908, 0x80E1, 0x1400, 0, 1, 1, 1, 1, 4};
                    break;
                case 0x8F98:  // GL_R16_SNORM
                    i = {0x1903, 0, 0x1402, 0, 2, 1, 1, 1, 2};
                    break;
                case 0x8F99:  // GL_RG16_SNORM
                    i = {0x8227, 0, 0x1402, 0, 2, 1, 1, 1, 4};
                    break;
                case 0x8F9A:  // GL_RGB16_SNORM
                    i = {0x1907, 0x80E0, 0x1402, 0, 2, 1, 1, 1, 6};
                    break;
                case 0x8F9B:  // GL_RGBA16_SNORM
                    i = {0x1908, 0x80E1, 0x1402, 0, 2, 1, 1, 1, 8};
                    break;
                case 0x906F:  // GL_RGB10_A2UI
                    i = {0x8D99, 0x8D9B, 0x8036, 0x8368, 4, 1, 1, 1, 4};
                    break;
            ...
            if (isValidFormat && isValidType)
                return {internalFormat, format,        type,         i.typeSize,
                        i.blockWidth,   i.blockHeight, i.blockDepth, i.blockSize};
        ...
        public:
            ...
            uint32_t uint32()
            {
                ...
                if (src != nullptr) std::memcpy(&i, src, 4);
        ...
        {
        public:
            ImageIterator(const TargetInfo& targetInfo, const FormatInfo& formatInfo, Stream stream,
                          uint32_t level)
            ...
            Image operator*() const
            {
                return {
                    ...
                    formatInfo_.isCompressed() ? formatInfo_.internalFormat : formatInfo_.format,
                    formatInfo_.type,
                    size_,
                    data_};
            }
        ...
        struct Texture
        {
            ...
            {
                static constexpr uint8_t ktx11[12]{0xAB, 0x4B, 0x54, 0x58, 0x20, 0x31,
                ...
                if (identifier == nullptr || std::memcmp(identifier, ktx11, 12) != 0) return;
                ...
                targetInfo_ = getTargetInfo(pixelWidth, pixelHeight, pixelDepth,
                                            numberOfArrayElements, numberOfFaces);

                if (!targetInfo_ || !formatInfo_) return;
